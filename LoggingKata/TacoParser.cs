...
namespace LoggingKata
{
    ...
    public class TacoParser
    {
        ...
        public ITrackable Parse(string line)
        {
            ...
            double latitude = ParseLatitude(cells[0]);
            ...
            //logger.LogInfo($"The name of this Taco Bell is: {name}");
        ...
        {
            if (double.TryParse(line, out double longitude))
            {
                return longitude;
            }
            else
            {
                logger.LogWarning("Longitude couldn't parse");
                return 0;
            }
        }
